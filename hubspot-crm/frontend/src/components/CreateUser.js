			...
			<div className="h-screen relative flex flex-col justify-center items-center">
				<div className="bg-white rounded-lg shadow-xl p-12 w-[420px]">
					...
					<form className="my-10" onSubmit={this.handleFormSubmit}>
						<h3 className="text-xl mb-4 text-l font-semibold text-gray-700">Create Account</h3>
						...
						<div className="relative mb-2">
							...
							<p className="mt-1">
								<Link className="text-sm font-medium text-purple-800 hover:underline cursor-pointer" to="/">
									Log in
								</Link>
							</p>
						</div>
